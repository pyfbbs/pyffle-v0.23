...
class Usergroup(Base): 
	...
	__table_args__ = {'useexisting':True,'sqlite_autoincrement':True}
	groupname = Column("groupname", VARCHAR, nullable=False,index=True,unique=None,default=None, primary_key = True)
	description = Column("description", VARCHAR, nullable=True,unique=None,default=None)
...
class Groupmember(Base): 
	...
	__table_args__ = {'useexisting':True,'sqlite_autoincrement':True}
	id = Column("id",INTEGER, Sequence('groupmemberseq'), nullable=False,index=True,unique=None,default=None, primary_key = True)
	username = Column("username", VARCHAR, nullable=True,unique=None,default=None)
	groupname = Column("groupname", VARCHAR, nullable=True,unique=None,default=None)
